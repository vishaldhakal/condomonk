...
export default function CustomModal({ linkText }) {
            ...
            <>
              ...
              <div className="row  align-items-start">
                      ...
                      <div className="text-center">
                        ...
                        <p className="mb-0 text-small  text-center px-3">Register to Receive Guaranteed Platinum Access & Prices, Incentives & Discounts, Floor Plans & More!
              ...
              <ModalBody>
                <SideContactForm></SideContactForm>
              </ModalBody>
