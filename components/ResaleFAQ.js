...
const ResaleFAQ = ({ property }) => {
  const faqs = [
    ...
    },
    {
      ...
      answer: `This property features ${property.BedroomsTotal} bedrooms and ${(property.WashroomsType1Pcs || 0) + (property.WashroomsType2Pcs || 0)} bathrooms.`
    },
    {
      question: "How many parking spaces are available?",
      answer: `${property.ParkingSpaces || 'Information about parking spaces'} parking spaces are available with this property.`
    },
    {
  ...
  return (
    <div className="bg-white rounded-lg pt-12 pb-10 max-w-5xl mx-auto">
      <h2 className="text-3xl font-bold mb-6">Some information about this property - {property.StreetName} {property.StreetSuffix}</h2>
