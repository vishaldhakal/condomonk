...
export async function getListingDetail(listingID) {
  ...
  try {
    ...
    const propertyUrl = `${baseUrl}Property?$filter=ListingKey eq '${listingKey}' ContractStatus eq 'Available' and InternetEntireListingDisplayYN eq true and StandardStatus eq 'Active' and MlsStatus ne 'Expired'`;
