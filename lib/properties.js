...
export async function getProperties({
  ...
  // Base filters
  queryArray.push(
    "ContractStatus eq 'Available' and StandardStatus eq 'Active' and InternetEntireListingDisplayYN eq true"
  );
...
export async function getListingDetail(listingID) {
  ...
  try {
    ...
    const propertyUrl = `${baseUrl}Property?$filter=ListingKey eq '${listingKey}' and InternetEntireListingDisplayYN eq true`;
