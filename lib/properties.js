...
export async function getProperties({
  ...
  // Base filters
  queryArray.push(
    "ContractStatus eq 'Available' and InternetEntireListingDisplayYN eq true and StandardStatus eq 'Active' and MlsStatus ne 'Expired'"
  );
...
export async function getListingDetail(listingID) {
  ...
  try {
    ...
    const propertyUrl = `${baseUrl}Property?$filter=ListingKey eq '${listingKey}' and ContractStatus eq 'Available' and InternetEntireListingDisplayYN eq true and StandardStatus eq 'Active' and MlsStatus ne 'Expired'`;
