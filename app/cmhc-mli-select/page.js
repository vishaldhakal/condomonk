export const metadata = {
  title: "CMHC MLI Select | Homebaba.ca",
  description:
    "Discover CMHC MLI Select: up to 95% financing, below-prime rates, long amortization, and more for multi-unit residential investments in Canada. Learn about eligibility, benefits, and how to get started with homebaba.ca.",
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center my-12">
          <a
            href="/cmhc-mli-select-calgary"
            className="flex items-center gap-3 px-6 py-5 rounded-2xl bg-white shadow-md border border-[#EAF7F3] hover:bg-[#EAF7F3] transition-all duration-200 text-[#12453B] font-semibold text-md"
            style={{ minWidth: 280, justifyContent: "center" }}
          >
            <MapPin className="w-6 h-6 text-green-600" />
            Learn More about CMHC MLI SELECT PROGRAM CALGARY
          </a>
          <a
            href="/cmhc-mli-select-edmonton"
            className="flex items-center gap-3 px-6 py-5 rounded-2xl bg-white shadow-md border border-[#EAF7F3] hover:bg-[#EAF7F3] transition-all duration-200 text-[#12453B] font-semibold text-md"
            style={{ minWidth: 280, justifyContent: "center" }}
          >
            <MapPin className="w-6 h-6 text-green-600" />
            Learn More about CMHC MLI SELECT PROGRAM EDMONTON
          </a>
        </div>
        {/* Footer Disclaimer */}
