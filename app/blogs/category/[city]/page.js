// // app/blogs/category/[city]/page.js
...
//             {/* Left: City Insights */}
//             <aside className="md:w-1/5 w-full mb-8 md:mb-0 md:h-[70vh] md:overflow-y-auto hide-scrollbar md:sticky md:top-10 z-10">
//               <Suspense
//                 fallback={
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: `Stay updated with the latest ${cityName} real estate insights, market trends, and property news through Condomonk's expert blog articles.`,
    alternates: {
      canonical: `https://condomonk.ca/blogs/category/${city}`,
    },
  };
}
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {/* Mobile dropdown - above blog grid */}
          <div className="md:hidden mb-4 z-30 relative">
            <CityInsights particularCity={city} cities={cities} />
          </div>

          {/* Two-column layout */}
          <div className="flex flex-col md:flex-row gap-8 items-start">
            {/* Desktop sidebar only */}
            <aside className="hidden md:block md:w-1/5 md:h-[70vh] md:overflow-y-auto hide-scrollbar md:sticky md:top-10">
              <Suspense
                fallback={
                  <div className="h-32 bg-gray-100 animate-pulse rounded-lg"></div>
                }
        ...
        <div className="mt-24 hidden md:block">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="max-w-xl mx-auto">
              <BottomContactForm proj_name={city} city="Blog Page" />
            </div>
          </div>
        </div>
      </div>
