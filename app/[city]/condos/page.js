...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...
    title: `${data.preconstructions.length}+ Pre Construction Condos in ${cityName}`,
    description: `Explore ${data.preconstructions.length}+ pre construction condos in ${cityName}. Find affordable 1-4 bedroom new construction condos with updated floor plans & pricing.`,
  };
}
