...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...
    title: `${data.preconstructions.length}+ Pre Construction Detached Homes in ${cityName}`,
    description: `Explore ${data.preconstructions.length}+ pre construction detached homes in ${cityName}. Find affordable new construction detached homes with updated floor plans & pricing.`,
  };
}
      ...
      <div className="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-gray-600 text-sm md:text-base">
            ...
            {cityName}. Affordable new construction detached homes in highly
            ...
            updates on new construction detached home projects.
          </h2>
